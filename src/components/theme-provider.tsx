...
import { Theme, ThemeVariant, getThemeByVariant, linearPurpleTheme } from '@/lib/theme';
...
export function ThemeProvider({ children, defaultTheme = 'linear-purple' }: ThemeProviderProps) {
  const [themeVariant, setThemeVariant] = React.useState<ThemeVariant>(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (stored && ['default', 'dark', 'light', 'midnight', 'linear-purple', 'linear-blue'].includes(stored)) {
