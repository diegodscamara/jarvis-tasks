...
export async function createProject(project: Omit<Database['public']['Tables']['projects']['Insert'], 'created_at' | 'updated_at'>): Promise<Project> {
  const supabase = await createSupabaseServerClient()
  const { data, error } = await supabase
    .from('projects')
    .insert(project)
...
export async function createLabel(label: Omit<Database['public']['Tables']['labels']['Insert'], 'created_at'>): Promise<Label> {
  const supabase = await createSupabaseServerClient()
  const { data, error } = await supabase
    .from('labels')
    .insert(label)
...
export async function createComment(comment: Omit<Database['public']['Tables']['comments']['Insert'], 'created_at'>): Promise<Comment> {
  const supabase = await createSupabaseServerClient()
  const { data, error } = await supabase
    .from('comments')
    .insert(comment)
